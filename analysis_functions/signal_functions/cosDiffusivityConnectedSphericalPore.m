function perpendicular_diffusivity = cosDiffusivityConnectedSphericalPore(par, x)
% Calculates the diffusivity measured in a connected spherical pore 
% geometry with a cosine OGSE sequence.
...
% 
% The ADC spectrum is that of a sphere's, but with an added offset term so that
...
perpendicular_diffusivity = 8*pi*pi*frequency.*frequency.*beta/gradient_duration + hindered_diffusion_coefficient;
