...
% Calculates the diffusion-weighted sine OGSE signal from inside a cylinder
...
Er = exp(-bSin(frequency, gradient_strength, gradient_duration).*sinDiffusivityCylinder(par,x(:,[1 3 4])));
