function perpendicular_diffusivity = cosDiffusivityPlane(par, x)
% Calculates the diffusivity measured perpendicular to a set of parallel planes
% with a cosine OGSE sequence.
%
% Inputs:
...
%
% Parameters:
% diffusion_coefficient: Diffusion coefficient between planes (in units of mm^2/ms)
% plane_separation: Distance between planes (in units of mm)
%
...
order = 20;
[lambda_n, B_n] = plane_factors(plane_separation, order);
